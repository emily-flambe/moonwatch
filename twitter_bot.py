...
def main():
    ...
    scheduler.add_job(tw.tweetTrendImage, CronTrigger.from_crontab('6 21 * * *'), args=["GME"]) 

    # Post summary at EOD
    scheduler.add_job(tw.tweetEODSummary, CronTrigger.from_crontab('5 21 * * *'), args=["GME"]) 
